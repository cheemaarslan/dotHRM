    ...
    private function getSaasPages()
    {
        return [
            ...
            [
                ...
                'content' => "Please read these terms carefully before using our dotHRM platform. By accessing or using our services, you agree to these terms.<br><br><b>Acceptance of Terms:</b> By creating an account or using our dotHRM product, you confirm that you have read, understood, and agree to be bound by these Terms of Service. If you do not agree, you may not use the platform.<br><br><b>Service Description:</b> Our platform provides businesses with Human Resource Management solutions, including but not limited to:<br>&bull; Employee records and profile management<br>&bull; Attendance and leave tracking<br>&bull; Payroll and compensation management<br>&bull; Performance evaluation tools<br>&bull; Reports, analytics, and integrations<br><br><b>User Responsibilities:</b> As a user of our dotHRM, you agree to:<br>&bull; Provide accurate and updated information when creating an account<br>&bull; Maintain confidentiality of your login credentials<br>&bull; Ensure that all uploaded content complies with applicable laws<br>&bull; Use the platform only for lawful HR management purposes<br><br><b>Subscription & Payments:</b> You agree to pay all fees associated with your chosen plan in accordance with the billing terms. Failure to pay may result in suspension or termination of your account.<br><br><b>Termination of Service:</b> We reserve the right to suspend or terminate your access if you violate these Terms or engage in harmful activities.<br><br><b>Data & Privacy:</b> Your data will be handled per our Privacy Policy. You are responsible for safeguarding your account access.<br><br><b>Limitation of Liability:</b> Our company shall not be held liable for any indirect, incidental, or consequential damages arising from your use of the dotHRM platform.",
                'meta_title' => 'Terms of Service - dotHRM',
                'meta_description' => 'Read our terms of service to understand the rules and responsibilities for using our dotHRM platform.',
                'is_active' => true,
                'sort_order' => 3
            ],
            [
