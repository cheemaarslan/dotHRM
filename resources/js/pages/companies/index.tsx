        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b bg-[#F0F0F1] hover:bg-[#F0F0F1] dark:border-gray-900 dark:bg-gray-900">
                  {columns.map((column) => (
                    <th
                      key={column.key}
                      className="px-4 py-3 text-left font-medium text-gray-500 dark:bg-gray-900"
                  ...
                  <th className="px-4 py-3 text-right font-medium text-gray-500 dark:bg-gray-900">
                    {t("Actions")}
                  </th>
                </tr>
              </thead>
