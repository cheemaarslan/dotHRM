      ...
      faqs: [
        {
          ...
          answer: 'dotHRM is an all-in-one HR platform that helps you manage employees, payroll, attendance, recruitment, and performance efficiently.'
        },
        {
          question: 'Can I automate payroll and leave tracking?',
          answer: 'Yes! dotHRM allows you to automate payroll calculations, generate payslips, and track employee leaves and attendance seamlessly.'
        },
        {
          question: 'Is my employee data secure?',
          answer: 'Absolutely. dotHRM uses enterprise-grade security measures to keep all sensitive HR data safe and confidential.'
        },
        {
          question: 'Can I manage recruitment and onboarding?',
          answer: 'Yes, dotHRM provides applicant tracking, interview management, and digital onboarding tools to simplify hiring.'
        },
        {
          question: 'Does dotHRM support performance evaluations?',
          answer: 'Yes, you can set goals, track KPIs, and run performance reviews directly within the platform.'
        },
        {
          question: 'Can dotHRM generate HR reports?',
      ...
      benefits: [
        {
          ...
          description: 'Stay informed about the latest dotHRM features and improvements.'
        },
        {
          icon: '💡',
          title: 'HR Insights',
