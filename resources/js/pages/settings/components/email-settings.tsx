...
export default function EmailSettings() {
  ...
  const [emailSettings, setEmailSettings] = useState({
    ...
    fromName: settings.email_from_name || 'dotHRM System'
  });
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center gap-2">
                      ...
                      <Label required htmlFor="driver" className="font-medium">{t("Mail Driver")}</Label>
                    </div>
                    <Input
                      id="driver"
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center gap-2">
                      <Server className="h-4 w-4 text-muted-foreground" />
                      <Label required htmlFor="host" className="font-medium">{t("SMTP Host")}</Label>
                    </div>
                    <Input
                      required
                      id="host"
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center gap-2">
                      <Server className="h-4 w-4 text-muted-foreground" />
                      <Label required htmlFor="port" className="font-medium">{t("SMTP Port")}</Label>
                      <TooltipProvider>
                        <Tooltip>
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center gap-2">
                      ...
                      <Label required htmlFor="username" className="font-medium">{t("SMTP Username")}</Label>
                    </div>
                    <Input
                      required
                      id="username"
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center gap-2">
                      ...
                      <Label required htmlFor="password" className="font-medium">{t("SMTP Password")}</Label>
                    </div>
                    <Input
                      required
                      id="password"
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center gap-2">
                      <Lock className="h-4 w-4 text-muted-foreground" />
                      <Label required htmlFor="encryption" className="font-medium">{t("Mail Encryption")}</Label>
                    </div>
                    <Select
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center gap-2">
                      <Mail className="h-4 w-4 text-muted-foreground" />
                      <Label required htmlFor="fromAddress" className="font-medium">{t("From Address")}</Label>
                    </div>
                    <Input
                      required
                      id="fromAddress"
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center gap-2">
                      <User className="h-4 w-4 text-muted-foreground" />
                      <Label required htmlFor="fromName" className="font-medium">{t("From Name")}</Label>
                    </div>
                    <Input
                      required
                      id="fromName"
