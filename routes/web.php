...
Route::middleware(['auth', 'verified', 'setting'])->group(function () {
    ...
    Route::middleware('plan.access')->group(function () {
        ...
        Route::middleware('permission:manage-organization-chart')->group(function () {
            Route::get('hr/organization-chart', [EmployeeController::class, 'organizationChart'])->name('hr.organization-chart.index');
        });
        ...
        Route::middleware('permission:manage-training-assessments')->group(function () {
        ...
        Route::middleware('permission:manage-job-postings')->group(function () {
            ...
            Route::post('hr/recruitment/job-postings/{jobPosting}/publish', [JobPostingController::class, 'publish'])->middleware('permission:publish-job-postings')->name('hr.recruitment.job-postings.publish');
            Route::post('hr/recruitment/job-postings/{jobPosting}/unpublish', [JobPostingController::class, 'unpublish'])->middleware('permission:publish-job-postings')->name('hr.recruitment.job-postings.unpublish');
        });
        ...
        Route::middleware('permission:manage-offer-templates')->group(function () {
            ...
            Route::get('hr/recruitment/offer-templates/create', [OfferTemplateController::class, 'create'])->middleware('permission:create-offer-templates')->name('hr.recruitment.offer-templates.create');
            ...
            Route::get('hr/recruitment/offer-templates/{offerTemplate}', [OfferTemplateController::class, 'show'])->middleware('permission:view-offer-templates')->name('hr.recruitment.offer-templates.show');
            Route::get('hr/recruitment/offer-templates/{offerTemplate}/edit', [OfferTemplateController::class, 'edit'])->middleware('permission:edit-offer-templates')->name('hr.recruitment.offer-templates.edit');
        ...
        Route::middleware('permission:manage-contract-templates')->group(function () {
            ...
            Route::get('hr/contracts/contract-templates/create', [ContractTemplateController::class, 'create'])->middleware('permission:create-contract-templates')->name('hr.contracts.contract-templates.create');
            ...
            Route::get('hr/contracts/contract-templates/{contractTemplate}', [ContractTemplateController::class, 'show'])->middleware('permission:view-contract-templates')->name('hr.contracts.contract-templates.show');
            Route::get('hr/contracts/contract-templates/{contractTemplate}/edit', [ContractTemplateController::class, 'edit'])->middleware('permission:edit-contract-templates')->name('hr.contracts.contract-templates.edit');
        ...
        Route::middleware('permission:manage-document-templates')->group(function () {
            ...
            Route::get('hr/documents/document-templates/create', [DocumentTemplateController::class, 'create'])->middleware('permission:create-document-templates')->name('hr.documents.document-templates.create');
            ...
            Route::get('hr/documents/document-templates/{documentTemplate}', [DocumentTemplateController::class, 'show'])->middleware('permission:view-document-templates')->name('hr.documents.document-templates.show');
            Route::get('hr/documents/document-templates/{documentTemplate}/edit', [DocumentTemplateController::class, 'edit'])->middleware('permission:edit-document-templates')->name('hr.documents.document-templates.edit');
        ...
        Route::middleware('permission:manage-leave-balances')->group(function () {
            ...
            Route::get('hr/leave-balances/sync-history', [LeaveBalanceController::class, 'syncHistory'])->name('hr.leave-balances.sync-history');
            Route::post('hr/leave-balances/sync', [LeaveBalanceController::class, 'sync'])->name('hr.leave-balances.sync');
        ...
        Route::middleware('permission:manage-attendance-records')->group(function () {
            ...
            Route::get('hr/attendance-records', [AttendanceRecordController::class, 'monthlyView'])->name('hr.attendance-records.index');
        ...
        Route::middleware('permission:manage-payroll-runs')->group(function () {
            ...
            Route::post('hr/payroll-runs/{payrollRun}/process', [PayrollRunController::class, 'process'])->middleware('permission:process-payroll-runs')->name('hr.payroll-runs.process');
